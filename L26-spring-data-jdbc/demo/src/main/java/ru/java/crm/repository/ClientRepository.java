...
public interface ClientRepository extends CrudRepository<Client, Long> {
    ...
    @Modifying // нужен в том случае, если выполняется query, но этот query ничего не возвращает.
    // В обратном случае, если query что-то возвращает, то @Modifying уже не нужен
