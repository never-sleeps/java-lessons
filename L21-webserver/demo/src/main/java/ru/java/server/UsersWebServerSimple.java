...
import ru.java.servlet.UsersApiServlet;
import ru.java.servlet.UsersServlet;
...
public class UsersWebServerSimple implements UsersWebServer {
    ...
    /** По умолчанию метод ничего не делает. Но в классах-наследниках его поведение переопределено */
