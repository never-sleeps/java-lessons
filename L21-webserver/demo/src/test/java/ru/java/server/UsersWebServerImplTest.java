...
import static ru.java.server.utils.WebServerHelper.*;
...
class UsersWebServerImplTest {
    ...
    private static final String DEFAULT_USER_PASSWORD = "qwerty";
    private static final User DEFAULT_USER = new User(DEFAULT_USER_ID, "John", DEFAULT_USER_LOGIN, DEFAULT_USER_PASSWORD);
