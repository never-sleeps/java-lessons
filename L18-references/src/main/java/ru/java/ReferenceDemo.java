...
public class ReferenceDemo {
    ...
    /**
     * WeakReference - Объекты с такими ссылками удаляются при первой же сборке мусора
     */
    private static void weak() {
        ...
        //Если раскомментировать, то gc удалит все объекты
        // System.gc();
    ...
    /**
     * SoftReference - Объекты с такими ссылками удаляются, когда памяти становится мало.
     * Т.е. они все удалятся перед OutOfMemoryError. Применяются к кэшах, чувствительных к памяти.
     */
    ...
    /**
     * PhantomReference - Такая ссылка на объект появляется, когдаобъект удаленсборщиком.
     * Своего рода – механизм завещания. Надо выполнить какое-то “post-mortem cleanup actions”
     */
