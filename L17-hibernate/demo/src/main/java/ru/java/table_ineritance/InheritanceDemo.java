package ru.java.table_ineritance;

import org.h2.tools.Console;
import org.hibernate.SessionFactory;
import ru.java.HibernateUtils;
import ru.java.table_ineritance.model.A;
import ru.java.table_ineritance.model.B;
import ru.java.table_ineritance.model.C;
...
public class InheritanceDemo {
    ...
    public static void main(String[] args) throws SQLException {
        SessionFactory sessionFactory = HibernateUtils.buildSessionFactory(HIBERNATE_CFG_FILE, A.class, B.class, C.class);
        System.out.println("\n\n-------------------------------------------\n\n");
