...
public class ProcessRunner {
    ...
    private static final String JOBS_PACKAGE_DIR = "/ru/processrunner/jobs/";
    private static final String JOB_CLASS = "ru.processrunner.jobs.Job";
