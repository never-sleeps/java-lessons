...
/**
 * ReentrantLock в отличие от synchronized позволяет более гибко управлять кодом.
 *
 */
public class ReentrantLockDemo {
    ...
    private void criticalSectionDoubleLock() {
        ...
        try {
            ...
            //сколько раз заблокировали, столько надо и разблокировать (число unlock() должно соответствовать числу lock() )
            lock.unlock();
            lock.unlock();
        }
        logger.info("after critical section");
