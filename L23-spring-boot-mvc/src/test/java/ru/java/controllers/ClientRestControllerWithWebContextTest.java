...
import ru.java.generators.ClientIdGeneratorImpl;
import ru.java.repostory.ClientRepositoryImpl;
import ru.java.services.ClientService;
import ru.java.services.ClientServiceImpl;
...
/*
В рамках этого теста будет поднят только web контекст.
 */
@DisplayName("WithContextTest: REST-контроллер клиентов ")
@WebMvcTest(ClientRestController.class)
@Import(value = {
        ClientServiceImpl.class,
        ClientIdGeneratorImpl.class,
        ClientRepositoryImpl.class}
) // эти бины будут положены в контекст
class ClientRestControllerWithWebContextTest {
